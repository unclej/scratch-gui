...
const ProjectFetcherHOC = function (WrappedComponent) {
    class ProjectFetcherComponent extends React.Component {
        ...
        componentDidUpdate (prevProps) {
            ...
            if (
                (this.props.isFetchingWithId && !prevProps.isFetchingWithId && !prevProps.isFetchingWithoutId) ||
                (this.props.isFetchingWithId && prevProps.isFetchingWithoutId)) {
                        ...
                        try {
                            ...
                            if (typeof projectJson.targets !== 'undefined') {
                                ...
                                for (let i = 0; i < projectJson.targets.length; i++) {
                                    ...
                                    if (/*eslint-disable */
                                        typeof projectJson.targets[i].variables['`jEk@4|i[#Fk?(8x)AV.-my variable'] !== 'undefined' &&
