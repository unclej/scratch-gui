...
const messages = defineMessages({
    message1: {
        defaultMessage: 'Don\'t worry, lessons are coming soon {emoji}',
        description: 'One of the "coming soon" random messages for yet-to-be-done features',
        id: 'gui.comingSoon.message1'
    },
    message2: {
        defaultMessage: 'Lessons are coming soon...',
        description: 'One of the "coming soon" random messages for yet-to-be-done features',
        id: 'gui.comingSoon.message2'
    },
    message3: {
        defaultMessage: 'We\'re working on lesson panel {emoji}',
        description: 'One of the "coming soon" random messages for yet-to-be-done features',
        id: 'gui.comingSoon.message3'
    }
});

class LessonComingSoonContent extends React.Component {
    constructor (props) {
        super(props);
        bindAll(this, [
            'setHide',
...
LessonComingSoonContent.propTypes = {
...
LessonComingSoonContent.defaultProps = {
    place: 'bottom'
};

const ComingSoon = injectIntl(LessonComingSoonContent);

const LessonComingSoonTooltip = props => (
...
LessonComingSoonTooltip.propTypes = {
...
LessonComingSoonTooltip.defaultProps = {
    delayHide: 0,
    delayShow: 0
};
